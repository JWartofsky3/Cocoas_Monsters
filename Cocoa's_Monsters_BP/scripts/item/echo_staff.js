            ...
            if (source.isSneaking) {
                ...
                system.runTimeout(() => {
                    ...
                    raycastHits.forEach((raycastHit) => {
                        ...
                        if (entity?.location) {
                            dimension.spawnParticle("minecraft:sonic_explosion", entity.location);
                        }
                    });
                    // get splash hits
                    ...
                    if (!targetLocation) {
                        targetLocation = addVector3(source.getHeadLocation(), multiplyVector3Number(source.getViewDirection(), SONIC_RANGE));
                    }
                    ...
                    for (let i = 1; i < dist; i++) {
                        dimension.spawnParticle("minecraft:sonic_explosion", addVector3(source.getHeadLocation(), multiplyVector3Number(source.getViewDirection(), i)));
                    }
                    system.runTimeout(() => {
                        ...
                        raycastHits.forEach((raycastHit) => {
                            ...
                            if (entity?.location) {
                                entity.applyDamage(SONIC_DAMAGE, {
                                    ...
                                    cause: entity.typeId === "minecraft:player"
